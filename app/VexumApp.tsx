...
export default function VexumApp({
  ...
  return <div className={rootClass}>
    ...
    <VexumDialog open={profileOpen} onClose={()=>setProfileOpen(false)} title="Profile" eyebrow="VEXUM IDENTITY" description="Manage how you appear across VEXUM Social, communities, collections, setups, and marketplace activity." size="xl" className="vxp-profile-dialog">
      <VexumSocial section="Profile"/>
    </VexumDialog>
