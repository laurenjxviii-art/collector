...
function MobileSetProducts({data,update,group,query,setQuery,back,openCard,openFilters,openSort,editMode,toggleEdit,openEdit,addToCollection,onAdd,openProgress}:{data:StoreData;update:(s:StoreData)=>void;group:SetGroup|null;query:string;setQuery:(v:string)=>void;back:()=>void;openCard:(id:string)=>void;openFilters:()=>void;openSort:()=>void;editMode:boolean;toggleEdit:()=>void;openEdit:(t:EditTarget)=>void;addToCollection:()=>void;onAdd:(id:string)=>void;openProgress:()=>void;onWishlist:(id:string)=>void}){
