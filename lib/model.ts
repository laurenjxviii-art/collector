...
export type Collection = {id:string; name:string; icon:string; color:string; logo?:string; libraryType?:string; libraryLine?:string};
...
export type Store = {version:1; collections:Collection[]; items:Item[]; profile?:{name:string; image:string}; preferences?:Preferences; history?:ValueSnapshot[]};
