...
export type Store = {version:1; collections:Collection[]; items:Item[]; libraryGroups?:Record<string,LibraryGroup>; profile?:{name:string; image:string}; preferences?:Preferences; history?:ValueSnapshot[]; wishlist?:Record<string,WishlistRecord>; wishlistPreferences?:WishlistPreferences; financialPreferences?:FinancialPreferences; financial?:FinancialData; setup?:SetupData};
